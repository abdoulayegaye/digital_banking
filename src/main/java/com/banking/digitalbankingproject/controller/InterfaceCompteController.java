...
public class InterfaceCompteController {
    ...
    void pageAjoutCompte(ActionEvent event) throws IOException {
        Outils.load(event, "Ajout Compte", "/FXML/creationComptes.fxml");
    }
    ...
    @FXML
    void searchClompte(ActionEvent event) {
    ...
    public void associerClient() {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/assoCompteClient.fxml"));
            Parent root = loader.load();

            AssoCompteClientController controller = loader.getController();
