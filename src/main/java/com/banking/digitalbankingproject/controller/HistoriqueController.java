...
public class HistoriqueController {
    ...
    @FXML
    private TableView<Operation> tableHistorique;
    @FXML
    private TableColumn<Operation, LocalDateTime> colDate;
    @FXML
    private TableColumn<Operation, String> colDescription;
    @FXML
    private TableColumn<Operation, Double> colMontant, colSolde;
    @FXML
    private ComboBox<Compte> comboCompte;
    @FXML
    private Button btnRetour, btnAfficher, btnGenerer;
    ...
    private void genererPdfReleve(File file, Compte compte, List<Operation> operations, String intervalleDates) throws IOException {
        ...
        for (int i = 1; i <= pdfDoc.getNumberOfPages(); i++) {
            ...
            barcodeImage.setFixedPosition(page.getPageSize().getWidth() - 250, 20);
