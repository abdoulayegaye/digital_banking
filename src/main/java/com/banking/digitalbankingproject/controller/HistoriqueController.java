...
public class HistoriqueController {
    ...
    public void getData(Compte compte, String dateDebut, String dateFin) {
        if (compte != null) {
            ...
            typeCompteLabel.setText("Compte unique");
    ...
    void genererRelever(ActionEvent event) {
        ...
        try {
            ...
            Paragraph adresseYoff = new Paragraph("Tel: +221 33 820 81 30 - Fax: +221 78 530 39 19", fontAdresse);
            adresseYoff.setAlignment(Element.ALIGN_LEFT);
            document.add(adresseYoff);

            // Infos du compte et client
            document.add(new Paragraph("Compte : " + numCompteLabel.getText()));
            document.add(new Paragraph("Titulaire : " + clientLabel.getText())); // Suppression de la référence à typeCompteLabel
            ...
            Paragraph texteBas = new Paragraph("\nCe relevé est un document officiel généré électroniquement..\nPour toute assistance, contactez-nous au +221 33 820 12 34 ou par email à support@digitalbanking.sn..", fontPied);
