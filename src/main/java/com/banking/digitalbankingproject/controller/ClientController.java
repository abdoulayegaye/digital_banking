...
public class ClientController {
    ...
    public void initialize() {
        ...
        tableViewClients.setRowFactory(tv -> {
            ...
            modifierItem.setOnAction(event -> {
                ...
                allerModifierClient(clientselect);
            });
            ...
            selectionner.setOnAction(event -> {
                clientselect = row.getItem();
                Notification.NotifSuccess("Succes", "Client Selectionne");
            });

            contextMenu.getItems().addAll(selectionner,modifierItem, supprimerItem);
    ...
    /*@FXML
    private void allerModifierClient(ActionEvent event) throws IOException {
        ...
        if (clientselect == null) {
            ...
            Outils.load(event, "Modifier Client", "/fxml/modifierClient.fxml");
        }
