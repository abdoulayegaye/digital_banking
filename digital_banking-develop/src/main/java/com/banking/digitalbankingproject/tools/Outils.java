...
public class Outils {
        ...
        public static BorderPane loadFXML(String fxmlPath) throws IOException {
    ...
    public static BorderPane load(ActionEvent event, String title, String url) throws IOException{
